...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Tabibi - Your Health, Connected" },
      { name: "twitter:description", content: "Tabibi connects patients with trusted doctors across the Arab world. Book appointments, consult online, and manage your health records all in one place." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/dd44f4ff-9afe-4a98-af23-2412360a88f8/id-preview-bc9a3912--5b0bd7dc-ec3f-4b87-a681-9a864b169449.lovable.app-1780063189608.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/dd44f4ff-9afe-4a98-af23-2412360a88f8/id-preview-bc9a3912--5b0bd7dc-ec3f-4b87-a681-9a864b169449.lovable.app-1780063189608.png" },
    ],
    links: [
      {
        rel: "stylesheet",
